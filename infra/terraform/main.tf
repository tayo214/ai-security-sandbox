...
# -----------------------------
# Lambda Function (AI Gateway - mock)
# -----------------------------
resource "aws_lambda_function" "ai_gateway" {
  function_name = "${local.name_prefix}-ai-gateway"
...
resource "aws_apigatewayv2_integration" "lambda_integration" {
  ...
  integration_uri        = aws_lambda_function.ai_gateway.arn
...
# Add throttling via default route settings (HTTP API uses stage route settings)
